        ...
        <div class="wrapper">
            <div class="clearfix">
                <section class="gornji">
                    <h2 id="glazba" class="naslovi">GLAZBA</h2>
                    <?php  
                ...
                <div class="clearfix">
                    <section class="donji">
                        <h2 id="sport" class="naslovi">SPORT</h2>
                        <?php  
                        $query = "SELECT * FROM clanci WHERE arhiva = 0 and kategorija = 'Sport' ORDER BY datum DESC LIMIT 3";
                        $result = mysqli_query($dbc, $query);
                        $i = 0;
                        while($row = mysqli_fetch_array($result)){
                            echo '<article>';
